/**
 * IndexedDB storage for voiceprints.
 * IndexedDB is used instead of localStorage because voice data can be large.
 */
...
export async function saveVoicePrint(voiceprint: VoicePrint): Promise<void> {
  const db = await openDB();
  return new Promise((resolve, reject) => {
